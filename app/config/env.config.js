...
const dev = {
  ...
  SMTP_AUTH_USER: process.env.DEV_SMTP_AUTH_USER,
  SMTP_AUTH_PASSWORD: process.env.DEV_SMTP_AUTH_PASSWORD,
...
const testing = {
  ...
  SMTP_HOST: process.env.TESTING_SMTP_HOST,
  SMTP_PORT: process.env.TESTING_SMTP_PORT,
  SMTP_AUTH_USER: process.env.TESTING_SMTP_AUTH_USER,
  SMTP_AUTH_PASSWORD: process.env.TESTING_SMTP_AUTH_PASSWORD,
  JWT_SECRET_KEY: process.env.JWT_SECRET_KEY,
  PAYMENT_GATEWAY_URL: process.env.PAYMENT_GATEWAY_URL,
  MARCHANT_ID: process.env.MARCHANT_ID,
  UPAYMENTS_USERNAME: process.env.UPAYMENTS_USERNAME,
...
const production = {
  ...
  SMTP_AUTH_USER: process.env.PRODUCTION_SMTP_AUTH_USER,
  SMTP_AUTH_PASSWORD: process.env.PRODUCTION_SMTP_AUTH_PASSWORD,
  JWT_SECRET_KEY: process.env.JWT_SECRET_KEY,
  PAYMENT_GATEWAY_URL: process.env.PAYMENT_GATEWAY_URL,
  MARCHANT_ID: process.env.MARCHANT_ID,
  UPAYMENTS_USERNAME: process.env.UPAYMENTS_USERNAME,
